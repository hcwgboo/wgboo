...
<grid:grid id="roleGridId" url="${adminPath}/sys/role/ajaxList">
	...
	<grid:button title="sys.role.authMenu"  groupname="opt" function="updateObj" outclass="btn-info"
                 winwidth="300px" innerclass="fa-plus" url="${adminPath}/sys/role/authMenu" />
