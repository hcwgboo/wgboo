...
<body class="white-bg"  formid="advertiseLogForm">
    <form:form id="advertiseLogForm" modelAttribute="data" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<table  class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				...
				<tr>
					<td  class="width-15 active text-right">	
		              <label>（0.创建，1.待审核，2.审核通过，3.拒绝）:</label>
		            </td>
					<td class="width-35">
					...
					<td  class="width-15 active text-right">	
		              <label>上下架（0.下架，1.上架）:</label>
		            </td>
					<td class="width-35">
						<form:input path="release" htmlEscape="false" class="form-control"      />
						<label class="Validform_checktip"></label>
					</td>
				</tr>
				<tr>
