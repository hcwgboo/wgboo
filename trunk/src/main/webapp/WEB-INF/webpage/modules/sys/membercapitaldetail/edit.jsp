...
<body class="white-bg"  formid="memberCapitalDetailForm">
    <form:form id="memberCapitalDetailForm" modelAttribute="data" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<table  class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				<tr>
					...
					<td  class="width-15 active text-right">	
		              <label>分销会员资金表id:</label>
		            </td>
					<td class="width-35">
						<form:input path="meCaptialId" htmlEscape="false" class="form-control"      />
						<label class="Validform_checktip"></label>
					</td>
				</tr>
				<tr>
					...
					<td class="width-35">
						<form:input path="sourceId" htmlEscape="false" class="form-control"      />
						<label class="Validform_checktip"></label>
					</td>
				</tr>
				<tr>
					<td  class="width-15 active text-right">	
		              <label>类型(1.直接转发，2.下级转发提成3.提现成功4.提现失败退回5.提现审核中）:</label>
		            </td>
					<td class="width-35">
				...
				<tr>
					...
					<td class="width-35">
						<form:input path="payAccount" htmlEscape="false" class="form-control"      />
						<label class="Validform_checktip"></label>
					</td>
					<td  class="width-15 active text-right">	
		              <label>微信:</label>
					...
					<td class="width-35">
						<form:input path="payType" htmlEscape="false" class="form-control"      />
						<label class="Validform_checktip"></label>
					</td>
				</tr>
				<tr>
