...
<html>
	...
	<head>
		<title>
			<spring:message code="sys.menu.edittitle" />
		</title>
		...
		<form:form id="menuForm" modelAttribute="data" method="post" class="form-horizontal">
			...
			<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
				<tbody>
					...
					<tr>
						<td class="width-15 active text-right">
							<label><font color="red">*</font>权限类别:</label>
						</td>
						<td class="width-35">
							<form:radiobuttons path="isshow" dict="qxnb" defaultValue="1" htmlEscape="false" cssClass="i-checks required" />
							<label class="Validform_checktip"></label>
						</td>
					</tr>
					<tr>
