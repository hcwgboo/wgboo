...
<body class="white-bg"  formid="microRadioCapitalDetailForm">
    <form:form id="microRadioCapitalDetailForm" modelAttribute="data" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<table  class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				<tr>
					...
					<td  class="width-15 active text-right">	
		              <label><font color="red">*</font>商家id:</label>
		            </td>
					<td class="width-35">
				...
				<tr>
					...
					<td class="width-35">
						<form:input path="nowMoney" htmlEscape="false" class="form-control"      />
						<label class="Validform_checktip"></label>
					</td>
				</tr>
				<tr>
