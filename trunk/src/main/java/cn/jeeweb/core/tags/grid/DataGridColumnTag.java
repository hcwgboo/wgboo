...
public class DataGridColumnTag extends AbstractGridHtmlTag {
	...
	private String selectChange = "true";
	...
	private String optCallback = "";//opt配置方法，为js方法，
	...
	private void addQuery() {
		...
		if (query) {
			...
			queryMap.put("selectValue", selectValue);
			queryMap.put("selectAll", selectAll);
			queryMap.put("selectChange", selectChange);
