...
public class ZTreeviewTag extends AbstractGridHtmlTag {
	...
	private String id = "ztreeview"; // 树唯一标示
	private String dataUrl = "";// 访问路径
	private Object datas;// 设置的数据
	private String labelValue="zTreeId";
	private String clickTree = "";// 事件
	private String title = "请选择组织架构";// 事件
	...
	public String getClickTree() {
		return clickTree;
	}

	public void setClickTree(String clickTree) {
		this.clickTree = clickTree;
	}
	...
	private void writeFragment() throws JspException {
		...
		String fragment = htmlComponentManager.getFragmentComponent("userdefine-treeselect", rootMap);
