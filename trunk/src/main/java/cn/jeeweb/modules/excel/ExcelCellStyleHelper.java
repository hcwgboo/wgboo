...
public class ExcelCellStyleHelper {
	...
	public static Font createFont(HSSFWorkbook workbook, String fontName, short size, boolean bold,
			boolean italic, boolean underLine, boolean deleteLine) {
		if (workbook == null)
			throw new IllegalArgumentException("please create workbook first");
